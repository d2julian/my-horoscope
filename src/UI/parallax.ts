...
import { withAnchorPoint } from "@/UI/anchor-point";
  ...
  return (value: number) => {
    ...
    const transform = {
      transform: [
        ...
        { perspective: 200 },
        {
          rotateY: `${interpolate(value, [-1, 0, 1, 2], [20, 0, 0, 20], Extrapolate.CLAMP)}deg`,
        },
        {
          rotateZ: `${interpolate(value, [-1, 0, 1, 2], [-20, 0, 0, -20], Extrapolate.CLAMP)}deg`,
        },
        { scale },
      ],
    };
